...
function TeamPortrait({ member }: { member: TeamMember }) {
  if (member.image) {
    return (
      <img
        src={member.image}
        alt={`${member.name}, ${member.role} at calderforge`}
        width={member.width}
    ...
    <section className="section founder-section" id="founder">
      <div className="container founder-layout">
        <div className="founder-portrait">
          <img
            src={founder.image}
            alt={`${founder.name}, ${founder.role} at calderforge`}
            width={founder.width}
        ...
        <div className="founder-copy">
          ...
          <blockquote>
            <p>&ldquo;calderforge exists to make ambitious digital work feel practical: understand the real problem, bring the right people together, and keep delivery transparent from start to finish.&rdquo;</p>
          </blockquote>
          <p>
            Muhammad Yasir leads calderforge&rsquo;s strategy and client partnerships, connecting business goals with focused product, engineering, automation, and growth delivery.
          </p>
