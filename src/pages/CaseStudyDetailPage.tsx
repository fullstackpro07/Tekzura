  ...
  return (
    <>
        ...
        <div className="container case-study-layout">
          ...
          <aside className="case-study-sidebar">
            ...
            <div className="case-study-sidebar-card">
              ...
              <p>Talk with calderforge about a project in {service?.shortTitle.toLowerCase() || 'this space'}.</p>
      ...
      <ConversionCTA
        ...
        description="If this case study sparked a product, automation, or growth idea, calderforge can help validate it and build the next useful version."
