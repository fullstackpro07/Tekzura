...
export default function BlogPage() {
  ...
  return (
    <>
      <Seo
        title="Insights"
        description="calderforge case studies and project insights on web development, AI automation, design, marketing, and infrastructure."
        path="/blog"
      />
      <PageHero
        eyebrow=""
        title="Case Studies and Practical Delivery Lessons."
        description="Explore how calderforge approaches product, growth, and operations work — from challenge and approach through measurable outcome."
        visual=""
      ...
      <ConversionCTA
        ...
        description="If a case study sparked a product, automation, or growth idea, calderforge can help validate it and build the next useful version."
