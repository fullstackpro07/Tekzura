...
export default function ProcessPage() {
  return (
    <>
      <Seo
        title="Process"
        description="See how calderforge delivers digital products — a clear five-stage process from discovery through launch."
        path="/process"
      />
      ...
      <PageHero
        ...
        visualAlt="calderforge team collaborating on a delivery plan"
        theme="dark"
      >
