...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    role: 'CTO',
    image: '/team/mohammad-sajjad.jpeg',
    width: 720,
    height: 840,
  ...
  
  {
    ...
    image: '/team/fozia-qasim.jpeg',
    width: 768,
    height: 782,
    bio: 'Builds full-stack SaaS products end to end, from architecture and APIs to responsive, production-ready interfaces.',
    group: 'Engineering & Product',
    gender: 'female',
  },
  {
    name: 'Muhammad Tahir Iqbal',
    role: 'Android/iOS Developer',
    image: '/team/muhammad-tahir-iqbal.jpeg',
    width: 1024,
    height: 1024,
    bio: 'Develops native and cross-platform mobile applications for Android and iOS, focused on performance and clean user experience.',
    group: 'Engineering & Product',
    gender: 'male',
  },
  {
    name: 'Rania Bibi',
    role: 'AI/ML Engineer',
    image: '/team/rania-bibi.jpeg',
    width: 1024,
    height: 1024,
    bio: 'Designs and deploys AI and machine learning solutions, from data preprocessing and model development to real-world integration.',
    group: 'Engineering & Product',
    gender: 'female',
  },
  {
